...
public class deletefromtheleft {
    ...
    public static void main(String[] args) {
        new Thread(null, null, "BlackRise", (long) 1e1)          //the last parameter is stack size which is desired, it is safe to chose 10^9 for all ques.
        {
            public void run() {
                Blackrise();
            }
    ...
    static void Blackrise() {                                                       //The name Blackrise is my pen name... you can change the name according to your wish........
        ...
        int l1=ch1.length;
        int l2=ch2.length;
        if(l1>=l2)find(ch1,ch2,l1,l2);
        else find(ch2,ch1,l2,l1);
    ...
    static void find(char ch1[], char ch2[], int l1,int l2)
    {
        int i;
        for(i=1;i<=l2;i++)
        {
            if(ch1[l1-i]!= ch2[l2-i])break;
        }
        if(i==1)System.out.println(l1+l2);
        else System.out.println(l1+l2 - 2*(i-1));
    }

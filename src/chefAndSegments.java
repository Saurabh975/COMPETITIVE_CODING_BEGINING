...
public class chefAndSegments {
    ...
    static void Blackrise() {                                                //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        while (t-- > 0) {
            ...
            pair ar[] = new pair[n];
            for (int i = 0; i < n; i++) ar[i] = new pair(ni(), ni());


            Comparator<pair> cl=new Comparator<pair>() {
                @Override
            ...
            Comparator<pair> cr=new Comparator<pair>() {
                @Override
                public int compare(pair o1, pair o2) {
            ...
            PriorityQueue<pair> pq = new PriorityQueue<>(cr);
            Arrays.sort(ar,cl);

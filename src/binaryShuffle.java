...
public class binaryShuffle {
    ...
    static void Blackrise() {                                                           //The name Blackrise is my pen name... you can change the name according to your wish........
        ...
        while (t-- > 0) {
            ...
            long b = input.nextLong() - 1;
            if(a==0 && b==0){pw.println(1);continue;}
            if (a == b + 1) {
                pw.println(0);
                continue;
            }
            ...
            if (y == 0 ||( b < 0 && a !=0)) pw.println(-1);
            else if (x == y) pw.println(1);
            else if (x > y) pw.println(2);
            else  pw.println(y - x + 1);
        }

...
public class GoodSubsets {
    ...
    static void Blackrise() {                                                       //The name Blackrise is my pen name... you can change the name according to your wish........
        ...
        while (t-- > 0) {
            ...
            Collections.sort(ar);
            if (ar.get(0) == 1) pw.println("YES");
            else if (n == 1) pw.println("NO");
            else {
                int hcf=gcd(ar.get(0),ar.get(1));
                if(hcf != ar.get(0))hcf=1;
                for(int i=2;i<n && hcf!=1; i++) {
                    int temp = gcd(hcf, ar.get(i));
                    if(temp!= hcf)hcf=1;
                }
                if(hcf==1)pw.println("YES");
                else pw.println("NO");
            }
        }

...
public class qualifyingtoPreelemination {
    ...
    static void Blackrise() {                                                //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        while(t-->0)
        {
            ...
            for(int i=0;i<n;i++)
            {
                ...
                else tm.put(x,tm.get(x)+1);
            }
            //int size=tm.size();
            //int key=tm.firstKey();
            int c=0;
            Arrays.sort(arr);
            //ar.add(new Pair(key,tm.get(key)));
            ...
            if(c==0)
                ...
                ar.add(new Pair(key,tm.get(key)+ar.get(ar.size()-1).y));
                c++;
                hm.put(key,ar.get(ar.size()-1).y);
            }
            //Collections.sort(ar);
            //pl(ar);
            pl(hm.get(arr[k-1]*-1));

...
public class vasyaAndPassword {
    ...
    static void Blackrise() {                                                //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        while (t-- > 0) {
            ...
            if (l > 0 && u > 0 && d > 0){ pl(s); continue;}
            else {
                if (l == 0 && u != 0 && d != 0)
                    if (d >= u) ch[dig.get(0)] = 'a';
                    else ch[up.get(0)] = 'a';

                else if (l != 0 && u == 0 && d != 0)
                    if (d >= l) ch[dig.get(0)] = 'A';
                    else ch[low.get(0)] = 'A';

                else if (l != 0 && u != 0 && d == 0)
                    if (l >= u) ch[low.get(0)] = '1';
                    else ch[up.get(0)] = '1';
            ...
            for(int i=0;i<ch.length;i++)pws(ch[i]);
            pl();
        }

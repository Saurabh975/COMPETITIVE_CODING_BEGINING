...
public class Abeautifulyear {
    ...
    public static void main(String[] args) {
        new Thread(null, null, "BlackRise", Integer.MAX_VALUE)          //the last parameter is stack size which is desired, it is safe to chose Max value for all question.
        {
            public void run() {
                Blackrise();
            }
    ...
    static int isDis(int y)
    {
        int y1=y%10;y/=10;
        int y2=y%10;y/=10;
        int y3=y%10;y/=10;
        int y4=y%10;
        if(y1==y2 || y1==y3 || y1==y4 || y2==y3 || y2==y4 || y3==y4)return 0;
        else return 1;
    }
} 
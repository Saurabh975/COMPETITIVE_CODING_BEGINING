...
public class theBits{
    ...
    static void Blackrise() {    //The name Blackrise is my pen name... you can change the name according to your wish
        ...
        int n=ni();
        char ch1[]=ns().trim().toCharArray();
        char ch2[]=ns().trim().toCharArray();
        long ar[]=new long[4];
        for(int i=0;i<n;i++)
        {
            if(ch1[i]=='0' && ch2[i]=='0')ar[0]++;
            else if(ch1[i]=='0' && ch2[i]=='1')ar[1]++;
            else if(ch1[i]=='1' && ch2[i]=='0')ar[2]++;
            else ar[3]++;
        }
        pl(ar[0]*ar[2] + ar[0]*ar[3] + ar[2]*ar[1]);

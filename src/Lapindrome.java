    ...
    static void Blackrise() {                                                       //The name Blackrise is my pen name... you can change the name according to your wish........
        ...
        while(t-->0) {
            ...
            if(l%2==0)
            {
                ...
                for(int i=0;i<l/2;i++)ar1.add(sb.charAt(i));
                Collections.sort(ar1);

                ArrayList<Character> ar2=new ArrayList<>();
                for(int i=l/2;i<l;i++)ar2.add(sb.charAt(i));
                Collections.sort(ar2);
                int flag=0;
                for(int i=0;i<ar1.size();i++)if(ar1.get(i)!=ar2.get(i))flag=1;
            ...
            else
            {
                ...
                ArrayList<Character> ar2=new ArrayList<>();
                for(int i=l/2 +1;i<l;i++)ar2.add(sb.charAt(i));
                Collections.sort(ar2);
                int flag=0;
                for(int i=0;i<ar1.size();i++)if(ar1.get(i)!=ar2.get(i))flag=1;
                if(flag!=1)pw.println("YES");
